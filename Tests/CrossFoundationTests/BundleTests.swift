...
final class BundleTests: XCTestCase {
    ...
    func testBundle() throws {
        ...
        // Swift will be: Contents/Resources/ -- file:///~/Library/Developer/Xcode/DerivedData/DemoApp-ABCDEF/Build/Products/Debug/CrossFoundationTests.xctest/Contents/Resources/Skip_CrossFoundationTests.bundle/
        // Kotlin will be: file:/SRCDIR/Skip/kip/CrossFoundationTests/modules/CrossFoundation/build/tmp/kotlin-classes/debugUnitTest/skip/foundation/
    ...
    func testBundleInfo() throws {
        ...
        let moduleName = name.split(separator: "_").last?.description ?? name // turn "Skip_CrossFoundationTests" into "CrossFoundationTests"
        XCTAssertEqual("SkipSource_CrossFoundationTests", name)
        XCTAssertEqual("CrossFoundationTests", moduleName)
        ...
        //XCTAssertEqual("Skip_CrossFoundationTests", info["CFBundleName"] as? String)
        #endif
    }
