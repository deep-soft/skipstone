...
final class FeatureSupportTests: XCTestCase {
    ...
    func testMultipleNamedEnumParameters() async throws {
        ...
        // val in = associated1
        //     ^
        // 31:54: error: parameter name expected
        // fun unexpectedEscapedCharacter(ascii: UByte, in: String, index: Int): JSONError = UnexpectedEscapedCharacterCase(ascii, in, index)
        //                                              ^
        // 31:129: error: expecting an expression
        // fun unexpectedEscapedCharacter(ascii: UByte, in: String, index: Int): JSONError = UnexpectedEscapedCharacterCase(ascii, in, index)
        //                                                                                                                         ^
        // 31:129: error: expecting ')'
        // fun unexpectedEscapedCharacter(ascii: UByte, in: String, index: Int): JSONError = UnexpectedEscapedCharacterCase(ascii, in, index)
        //                                                                                                                         ^
        // 31:131: error: expecting member declaration
        // fun unexpectedEscapedCharacter(ascii: UByte, in: String, index: Int): JSONError = UnexpectedEscapedCharacterCase(ascii, in, index)
        //                                                                                                                           ^
        // 31:133: error: expecting member declaration
        // fun unexpectedEscapedCharacter(ascii: UByte, in: String, index: Int): JSONError = UnexpectedEscapedCharacterCase(ascii, in, index)
        //                                                                                                                             ^
        // 31:138: error: expecting member declaration
        // fun unexpectedEscapedCharacter(ascii: UByte, in: String, index: Int): JSONError = UnexpectedEscapedCharacterCase(ascii, in, index)
        ...
        sealed class JSONError: Exception(), Error {
