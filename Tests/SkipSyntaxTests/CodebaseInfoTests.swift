...
final class CodebaseInfoTests: XCTestCase {
    ...
    func testTrailingClosures() async throws {
        ...
        XCTAssertEqual([.function([.init(label: "tc1", type: .function([], .array(.int), [], nil))], .function([.init(type: .named("TestEnum", []))], .int, [], nil), [], nil)], context.matchFunction(name: "trailingClosureF3", inConstrained: .named("TestClass", []), arguments: [LabeledValue(label: nil, value: ArgumentValue(type: .function([], .none, [], nil), isFirstTrailingClosure: true))]).map(\.signature))
    }
