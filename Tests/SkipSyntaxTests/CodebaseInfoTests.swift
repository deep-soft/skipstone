...
final class CodebaseInfoTests: XCTestCase {
    ...
    func testCodebaseInfoSymbolStability() async throws {
        ...
        try await transpiler.transpile(handler: { _ in })
