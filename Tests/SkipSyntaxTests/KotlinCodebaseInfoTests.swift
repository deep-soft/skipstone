...
final class KotlinCodebaseInfoTests: XCTestCase {
    ...
    func testProtocolTypeHasMember() async throws {
        let context = try await setUpContext()
        XCTAssertEqual(false, context.isKotlinInterfaceMember(name: "protocolVar", parameters: nil, in: .named("NonExistantTypeName", [])))

        XCTAssertEqual(false, context.isKotlinInterfaceMember(name: "baseProtocolVar", parameters: nil, in: .named("TestsNonAnyObjectRestrictedProtocol", [])))
        XCTAssertEqual(true, context.isKotlinInterfaceMember(name: "baseProtocolVar", parameters: nil, in: .named("TestsAnyObjectRestrictedProtocol", [])))

        let functionParameters: [TypeSignature.Parameter] = [.init(label: "i", type: .int)]
        XCTAssertEqual(false, context.isKotlinInterfaceMember(name: "baseProtocolFunc", parameters: functionParameters, in: .named("TestsNonAnyObjectRestrictedProtocol", [])))
        XCTAssertEqual(true, context.isKotlinInterfaceMember(name: "baseProtocolFunc", parameters: functionParameters, in: .named("TestsAnyObjectRestrictedProtocol", [])))
        XCTAssertEqual(false, context.isKotlinInterfaceMember(name: "baseProtocolFunc", parameters: [.init(label: "j", type: .int)], in: .named("TestsAnyObjectRestrictedProtocol", [])))

        XCTAssertEqual(true, context.isKotlinInterfaceMember(name: "baseProtocolVar", parameters: nil, in: .named("TestsTransitiveAnyObjectRestrictedProtocol", [])))
        XCTAssertEqual(true, context.isKotlinInterfaceMember(name: "baseProtocolFunc", parameters: functionParameters, in: .named("TestsTransitiveAnyObjectRestrictedProtocol", [])))

        XCTAssertEqual(true, context.isKotlinInterfaceMember(name: "baseProtocolVar", parameters: nil, in: .named("TestsProtocolImpl", [])))
        XCTAssertEqual(true, context.isKotlinInterfaceMember(name: "baseProtocolFunc", parameters: functionParameters, in: .named("TestsProtocolImpl", [])))
    }
}
