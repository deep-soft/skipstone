...
final class KotlinCodebaseInfoTests: XCTestCase {
    ...
    func testProtocolTypeHasMember() async throws {
        let context = try await setUpContext()
        XCTAssertEqual(false, context.isProtocolMember(name: "protocolVar", parameters: nil, isStatic: false, in: .named("NonExistantTypeName", [])))

        XCTAssertEqual(false, context.isProtocolMember(name: "baseProtocolVar", parameters: nil, isStatic: false, in: .named("TestsNonAnyObjectRestrictedProtocol", [])))
        XCTAssertEqual(true, context.isProtocolMember(name: "baseProtocolVar", parameters: nil, isStatic: false, in: .named("TestsAnyObjectRestrictedProtocol", [])))

        let functionParameters: [TypeSignature.Parameter] = [.init(label: "i", type: .int)]
        XCTAssertEqual(false, context.isProtocolMember(name: "baseProtocolFunc", parameters: functionParameters, isStatic: false, in: .named("TestsNonAnyObjectRestrictedProtocol", [])))
        XCTAssertEqual(true, context.isProtocolMember(name: "baseProtocolFunc", parameters: functionParameters, isStatic: false, in: .named("TestsAnyObjectRestrictedProtocol", [])))
        XCTAssertEqual(false, context.isProtocolMember(name: "baseProtocolFunc", parameters: [.init(label: "j", type: .int)], isStatic: false, in: .named("TestsAnyObjectRestrictedProtocol", [])))

        XCTAssertEqual(true, context.isProtocolMember(name: "baseProtocolVar", parameters: nil, isStatic: false, in: .named("TestsTransitiveAnyObjectRestrictedProtocol", [])))
        XCTAssertEqual(true, context.isProtocolMember(name: "baseProtocolFunc", parameters: functionParameters, isStatic: false, in: .named("TestsTransitiveAnyObjectRestrictedProtocol", [])))

        XCTAssertEqual(true, context.isProtocolMember(name: "baseProtocolVar", parameters: nil, isStatic: false, in: .named("TestsProtocolImpl", [])))
        XCTAssertEqual(true, context.isProtocolMember(name: "baseProtocolFunc", parameters: functionParameters, isStatic: false, in: .named("TestsProtocolImpl", [])))
    }
}
