...
func aes(nonce: AES.GCM.Nonce? = nil, keyBase64 keyString: String? = nil, data: Data, encrypt: Bool, currentDate: Date = Date()) throws -> Data {
    ...
    let keyWheel = [
        ...
        (k(0x23, 0xB7, 0x15, 0x1D, 0x6B, 0xDC, 0x4F, 0x0E, 0x98, 0xC8, 0x03, 0x4E, 0xB5, 0x85, 0x8A, 0xC1), date(month: 1, year: 2025)),
        (k(0x23, 0xB7, 0x15, 0x1D, 0x6B, 0xDC, 0x4F, 0x0E, 0x98, 0xC9, 0x03, 0x4E, 0xB5, 0x85, 0x8A, 0xC1), date(month: 4, year: 2025)),
        (k(0x23, 0xB7, 0x15, 0x1D, 0x6B, 0xDC, 0x4F, 0x0E, 0x98, 0xC9, 0x03, 0x4A, 0xB5, 0x85, 0x8A, 0xC1), date(month: 7, year: 2025)),
        (k(0x23, 0xB7, 0x15, 0x1D, 0x6B, 0xDC, 0x4F, 0x0E, 0x98, 0xC9, 0x03, 0x4A, 0xB5, 0x81, 0x8A, 0xC1), date(month: 10, year: 2025)),

        (k(0x23, 0xB7, 0x11, 0x1D, 0x6B, 0xDC, 0x4F, 0x0E, 0x98, 0xC8, 0x03, 0x4E, 0xB5, 0x85, 0x8A, 0xC1), date(month: 1, year: 2026)),
        (k(0x23, 0xB7, 0x15, 0x1D, 0x6B, 0xDC, 0x4F, 0x0E, 0x98, 0xC9, 0x03, 0x4E, 0xB5, 0x81, 0x8A, 0xC1), date(month: 4, year: 2026)),
        (k(0x20, 0xB7, 0x15, 0x1D, 0x6B, 0xDC, 0x4F, 0x0E, 0x98, 0xC9, 0x03, 0x4A, 0xB5, 0x85, 0x8A, 0xC1), date(month: 7, year: 2026)),
        (k(0x23, 0xB7, 0x15, 0x1D, 0x6B, 0xDC, 0x4F, 0x0E, 0x98, 0xC9, 0x01, 0x4A, 0xB5, 0x81, 0x8A, 0xC1), date(month: 10, year: 2026)),
