...
internal let validLicenseHeaders = [
    ...
    try! NSRegularExpression(pattern: #".*Open\sSoftware\sLicense.*"#), // full license text
    try! NSRegularExpression(pattern: #".*SPDX-License-Identifier: (?:OSL|GPL|LGPL|AGPL)-3*"#), // SPDX ID: accept OSL-3.0, LGPL-3.0-only, GPL-3.0-or-greater, AGPL-3.1
]
...
func aes(nonce: AES.GCM.Nonce? = nil, keyBase64 keyString: String? = nil, data: Data, encrypt: Bool, currentDate: Date = Date()) throws -> Data {
    ...
    let keyWheel = [
        ...
        (k(0x23, 0xB7, 0x15, 0x1D, 0x6B, 0xDC, 0x4F, 0x0E, 0x98, 0xC8, 0x03, 0x4E, 0xB5, 0x85, 0x8B, 0xC1), date(month: 1, year: 2026)),
        (k(0x23, 0xB7, 0x15, 0x1D, 0x6B, 0xDC, 0x4F, 0x0E, 0x98, 0xC8, 0x03, 0x4E, 0xB5, 0x85, 0x8B, 0xC1), date(month: 4, year: 2026)),
        (k(0x23, 0xB7, 0x15, 0x1D, 0x6B, 0xDC, 0x4F, 0x0E, 0x98, 0xC8, 0x03, 0x4E, 0xB5, 0x85, 0x8B, 0xC1), date(month: 7, year: 2026)),
        (k(0x23, 0xB7, 0x15, 0x1D, 0x6B, 0xDC, 0x4F, 0x0E, 0x98, 0xC8, 0x03, 0x4E, 0xB5, 0x85, 0x8B, 0xC1), date(month: 10, year: 2026)),
