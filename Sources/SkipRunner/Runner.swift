...
public struct VersionCommand: SingleStreamingCommand {
    ...
    public func executeCommand() -> Output {
        self.msg(.trace, "trace")
        self.msg(.info, "info")
        self.msg("message")
        self.msg(.warn, "warning")
...
struct PrecheckAction: Action, CheckPhase {
    public static var configuration = CommandConfiguration(commandName: "precheck", abstract: "Perform transpilation prechecks")
...
struct GradleAction: GradlePhase {
    public static var configuration = CommandConfiguration(commandName: "gradle", abstract: "Gradle build system interface")
