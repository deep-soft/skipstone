...
// SKIP XXX INSERT: public fun Date(timeIntervalSince1970: TimeInterval): SkipDate { return SkipDate.create(timeIntervalSince1970 = timeIntervalSince1970) }

// [gradle] e: src/main/kotlin/skip/foundation/Date.kt:28:1 Conflicting overloads: public fun Date(timeIntervalSince1970: TimeInterval): SkipDate defined in cross.foundation in file Date.kt, public fun Date(timeIntervalSinceReferenceDate: TimeInterval): SkipDate defined in cross.foundation in file Date.kt
