extension Message {
    ...
    static func kotlinTypeAliasNested(_ sourceDerived: SourceDerived) -> Message {
        return Message(severity: .error, message: "Kotlin does not support typealias declarations within types. Consider moving this to a top level declaration", sourceDerived: sourceDerived)
    }
